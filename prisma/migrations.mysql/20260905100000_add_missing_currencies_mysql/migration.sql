-- Add missing display/conversion currencies (see Postgres migration
-- 20260905100000_add_missing_currencies for the full list).

INSERT IGNORE INTO `Currency` (`code`, `name`, `symbol`, `decimals`, `rate`, `isDefault`, `active`, `sortOrder`)
VALUES
