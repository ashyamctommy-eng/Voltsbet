    ...
    <>
      ...
      {s.telegramEnabled && s.telegram && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-20 left-4 z-40 flex items-center gap-2 rounded-full bg-[#229ED9] px-4 py-2.5 text-sm font-bold text-white shadow-lg transition-transform hover:scale-105 xl:bottom-6 xl:left-6"
          style={{ display: s.telegramPosition === "bottom-right" ? "none" : "flex" }}
