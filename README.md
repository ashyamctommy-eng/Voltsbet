...
Markets fetched: `h2h, spreads, totals, h2h_h1, totals_h1, h2h_h2, totals_h2,
correct_score`. Live minutes are **estimated** from kickoff — The Odds API has no
match clock; `completed` flag and scores are authoritative.
